...
public class ExcelUtil {
	...
	ClassNotFoundException, IntrospectionException, ParseException {
	    ...
	    public static void createTableRows(XSSFSheet sheet, Map<Integer, List<ExcelBean>> map, List objs, Class clazz ,XSSFWorkbook workbook)
	     ...
	     * @throws
	     */
	    public static  void setPic(XSSFSheet sheet ,Cell cell ,Object rtn ,XSSFWorkbook workbook){
	    	try{
	    /*	byte[] x =	ByteAndObject.objectToByteArray(rtn);*/
	    	XSSFDrawing patriarch = sheet.createDrawingPatriarch();
       	 XSSFClientAnchor anchor = new XSSFClientAnchor(0, 0, 50, 50, cell.getColumnIndex(), cell.getRowIndex(), cell.getColumnIndex()+1, cell.getRowIndex()+1);
       	 anchor.setAnchorType(AnchorType.DONT_MOVE_AND_RESIZE);
        /* ByteAndFile.byte2File((byte[])rtn, "D:/", "2.png");*/
         patriarch.createPicture(anchor, workbook.addPicture((byte[])rtn,  XSSFWorkbook.PICTURE_TYPE_PNG));
	    	}catch(Exception e){
	    		e.printStackTrace();
	    	}
	    }
