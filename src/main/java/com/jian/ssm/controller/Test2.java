...
public class Test2 {
	public static void main(String[] args) {
        ...
        try {
            FileOutputStream out = new FileOutputStream("D:/AddPhotoUrl.xlsx");
            ...
            //参数7
            //参数8   
            XSSFClientAnchor anchor = new XSSFClientAnchor(100, 100, 255, 255, cell.getColumnIndex(), cell.getRowIndex(), cell.getColumnIndex()+1, cell.getColumnIndex()+1);
            anchor.setAnchorType(AnchorType.DONT_MOVE_DO_RESIZE);
            
            
            ByteArrayOutputStream byteOutPut = new ByteArrayOutputStream();
            //读取到图片信息
            BufferedImage  bufferImage =ImageIO.read(new File("D:/1.png"));
